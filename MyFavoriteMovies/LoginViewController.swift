...
class LoginViewController: UIViewController {
    ...
    private func getRequestToken() {
        ...
        let task = appDelegate.sharedSession.dataTask(with: request) { (data, response, error) in
            ...
            self.loginWithToken(self.appDelegate.requestToken!, userName, userPassword)
        }
    ...
    private func loginWithToken(_ requestToken: String, _ userName : String, _ userPassword : String) {
        ...
        var methodParameters = [
            ...
            Constants.TMDBParameterKeys.Password: userPassword
        ]
